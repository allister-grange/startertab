...
import {
  ...
  eightTileGridLayout,
  sixTileGridLayout,
  singleLargeTileGridLayout,
  twoTileGridLayout,
} from "@/helpers/gridLayout";
import { SetterOrUpdater } from "recoil";
import { vectors } from "@/helpers/particleEffects";
  ...
  themes: [
    ...
    },
    {
      ...
      globalSettings: {
        ...
        tileSize: "medium",
        backgroundColor: "#000",
        backgroundEffectsOptions: JSON.stringify({
          ...{
            background: {
              color: {
                value: "#000",
    ...
    },
    {
      ...
      globalSettings: {
        ...
        textColor: "#2F2E2C",
        subTextColor: "#6B6966",
        sidebarBackgroundColor: "#EFEEE9",
        sidebarBorderColor: "#DAD7D0",
        tileType: "None",
        themePickerBubbleColor:
          "linear-gradient(90deg, #F5F4F0 50%, #2F2E2C 50%);",
        borderRadius: "15px",
        gridGap: "16px",
      },
      tileLayout: singleLargeTileGridLayout,
      tiles: [
        {
          tileId: 0,
          ...
          tileSize: "large",
          clockHandsColor: "#2F2E2C",
          clockBackgroundColor: "#FDFCFA",
          clockBorderColor: "#E4E2DD",
        },
      ],
    },
    {
      themeName: "Minimal Clock Dark",
      downloadedFromMarketplace: false,
      globalSettings: {
        tileId: -1,
        tileSize: "medium",
        ...
        tileType: "None",
        themePickerBubbleColor:
          "linear-gradient(90deg, #121212 50%, #E8E6E1 50%);",
        borderRadius: "15px",
        gridGap: "16px",
      },
      tileLayout: singleLargeTileGridLayout,
      tiles: [
        {
          ...
          tileType: "Clock of Clocks",
          tileSize: "large",
          clockHandsColor: "#E8E6E1",
          clockBackgroundColor: "#1C1C1C",
          clockBorderColor: "#333333",
        },
      ],
    },
  ],
